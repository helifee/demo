...
import com.yonyou.itf.mdm07.sharing.IMdSharingThirdPartService;
...
public class TestServiceImpl implements IMdSharingThirdPartService {
	...
	public OuterSystemRetVO distributeMd(String mdType, String action, String masterData) {
		...
		if(StringUtils.isEmpty(entityCode)) {
			retVO.setSuccess(false);
			retVO.setErrorMsg("请检查第三方系统是否正确配置映射关系！");
			return retVO;
		}
